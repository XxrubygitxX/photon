...
int main()
{
    ...
    while (active)
    {
        ...
        int model_location = glGetUniformLocation(shader->m_ShaderProgram, "model");
        glUniformMatrix4fv(model_location, 1, GL_FALSE, glm::value_ptr(model));

        int view_location = glGetUniformLocation(shader->m_ShaderProgram, "view");
        glUniformMatrix4fv(view_location, 1, GL_FALSE, glm::value_ptr(view));

        int projection_location = glGetUniformLocation(shader->m_ShaderProgram, "projection");
